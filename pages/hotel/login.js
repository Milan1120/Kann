...
const Login = () => {
  ...
  return ( 
    ...
    <div className='flex'>
      ...
      <img src='https://source.unsplash.com/random/900x900/?hotels,restaurants,city' className='h-full w-full'/>
      </div>
          ...
          <div className="flex my-16 items-center justify-center max-w-7xl w-full">
            <div id='login' className="flex justify-center">
              <div className="flex flex-col justify-center items-center md:flex-row shadow rounded-xl max-w-7xl w-[90%]  m-2">
                <form action='/api/hotellogin' method='POST' className=" w-full md:w-3/4 bg-white p-8 shadow-xl">
                  ...
                  <div className="text-center mt-7">
                    <button type="submit" value="Login" className=" px-24 md:px-[118px] lg:px-[140px] py-2 rounded-md text-white bg-gradient-to-l from-red-700 to-blue-900 font-medium m-2 mb-6 ">
                      Sign In
                    </button>
                  </div>
                </form>
                <div className="h-[100%] w-full md:w-1/3  bg-gradient-to-l from-red-700 to-blue-900  items-center flex justify-center">
                  <div className="text-white text-base font-semibold text-center my-10 space-y-2 m-2">
                    <h1 className="text-5xl">New Here?</h1>
                    <h1 className="my-2">
                      Sign Up here
                    </h1>
                    <Link href={'/hotel/signup'} className="hover:shadow-xl  duration-400 bg-white flex items-center justify-center my-2 rounded-2xl px-4 text-blue-800 py-1">
                      SignUp
                    </Link>
                  </div>
                </div>
